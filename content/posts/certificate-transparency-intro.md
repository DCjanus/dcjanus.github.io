...
我接触 CT 是因为在 Cloudflare 控制台里看到了 Certificate Transparency Monitoring[^cf-ct]。完成域名验证之后，可以订阅“证书变更提醒”：每当有 CA 为我的域名签发新证书，Cloudflare 就会在几分钟内给我发邮件。第一次收到提醒时，我才意识到：即使证书由第三方代办，也能第一时间得知变更情况。从那以后我会定期拉日志增量，确认提醒对应的条目确实存在。
